    ...
    <div class="topnav">
     ...
     <c:if test="${book ne null}">
        <div style="height: 200px; width: 30%;">
            <form action="${pageContext.request.contextPath}/librarian/updateBook" method="post">
                <div class="mb-3">
                    <input type="hidden" class="form-control" value="${book.bId}" id="exampleInputEmail1" name="bid">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Book Title</label>
                    <input type="text" class="form-control" value="${book.bTitle}" id="exampleInputEmail1" name="btitle">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Book Author</label>
                    <input type="text" class="form-control" value="${book.bAuthor}" id="exampleInputEmail1" name="bauthor">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Book Category</label>
                    <input type="text" class="form-control" value="${book.bCategory}" id="exampleInputEmail1" name="bcategory">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Book Qty.</label>
                    <input type="text" class="form-control" value="${book.bCount}" id="exampleInputPassword1" name="bcount">
                </div>
